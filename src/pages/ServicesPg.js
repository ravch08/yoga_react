...
import serviceImg from '../assets/service-tab-img1.jpg';
               ...
               <div className="d-flex serv-det">
                  ...
                  <div className="tab-content" id="myTabContent">
                     ...
                     <div className="tab-pane fade show active" id="tab1">
                        ...
                        <p>Lorem Ipsn gravida nibh vel velit auctor aliquetenean
                           sollicitudin, lorem quis bibendum.
                        </p>
                        <ul className="ullist">
                           <li>The Friendlier, Easier Place to Bank.</li>
                           <li>
                              The Key To Success Is Staying With A Positive Attitude!</li>
                           <li>
                              From Humble Beginnings Come Great Things.</li>
                           <li>
                              Today May Be Just Like Any Other Day, But It’s Yours!</li>
                           <li>
                              The Friendlier, Easier Place to Bank.</li>
