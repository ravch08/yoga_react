...
import gallery1 from '../assets/gal-1.jpg';
import gallery2 from '../assets/gal-2.jpg';
import gallery3 from '../assets/gal-3.jpg';
import gallery4 from '../assets/gal-4.jpg';
import gallery5 from '../assets/gal-5.jpg';
import gallery6 from '../assets/gal-6.jpg';
         ...
         <div className="gallery-sec">
            <div className="container p-0">
               ...
               <div className="row" id="gallery">
                  <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-5 pics animation all 2">
                     <Link to="events-detail">
                        <figure><img className="img-fluid" src={gallery1} alt="Card" /></figure>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-5 pics animation all 1">
                     <Link to="events-detail">
                        <figure><img className="img-fluid" src={gallery2} alt="Card" /></figure>
                        <div className="album_name">
                           <h3 className="pb-2">Album Name </h3>
                        </div>
                     </Link>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-5 pics animation all 1">
                     <Link to="events-detail">
                        <figure><img className="img-fluid" src={gallery3} alt="Card" /></figure>
                        <div className="album_name">
                           <h3 className="pb-2">Album Name </h3>
                        </div>
                     </Link>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-5 pics animation all 2">
                     <Link to="events-detail">
                        <figure><img className="img-fluid" src={gallery4} alt="Card" /></figure>
                        <div className="album_name">
                           <h3 className="pb-2">Album Name </h3>
                        </div>
                     </Link>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-5 pics animation all 2">
                     <Link to="events-detail">
                        <figure><img className="img-fluid" src={gallery5} alt="Card" /></figure>
                        <div className="album_name">
                           <h3 className="pb-2">Album Name </h3>
                        </div>
                     </Link>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-5 pics animation all 1">
                     <Link to="events-detail">
                        <figure><img className="img-fluid" src={gallery6} alt="Card" /></figure>
                        <div className="album_name">
                           <h3 className="pb-2">Album Name </h3>
                        </div>
                     </Link>
               ...
               <div className="text-center">
                  <Link to="events-detail" className="w-btn btn-s" >View More</Link>
               </div>
            </div>
         </div>
                           ...
                           <div className="datepicker datepicker-inline">
                                 ...
                                 <table className="table table-condensed">
                                    <thead>
                                       <tr>
                                          ...
                                          <th colspan="5" className="datepicker-switch text-center">January 2020</th>
                              ...
                              <div className="datepicker-months" style={{ display: "none" }}>
                                 <table className="table table-condensed">
                                    <thead>
                                       <tr>
                                          <th className="prev" style={{ visibility: "visible" }}>«</th>
                                          <th colspan="5" className="datepicker-switch">2020</th>
                                          <th className="next" style={{ visibility: "visible" }}>»</th>
                                       </tr>
                                    </thead>
                                    <tbody>
                                       <tr>
                                          <td colspan="7"><span className="month active">Jan</span>
                              ...
                              <div className="datepicker-years" style={{ display: "none" }}>
                                 <table className="table table-condensed">
                                    ...
                                    <tbody>
                                       <tr>
                                          <td colspan="7"><span className="year old">2019</span>
