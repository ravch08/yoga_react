         ...
         <div className="container">
            <div className="row">
               <div className="col-12 col-sm-12 col-md-3">
                  <h4>ABOUT US</h4>
                  <p>Lorem ipsum proin gravida nibh vel veliauctor aliquenean sollicitudiem quis bibendum auctornisi
                     consequat ipsutis sem
                     nibh id elit.</p>
               ...
               <div className="col-6 col-sm-6 col-xs-6 col-md-3">
                  <h4>Open Hours</h4>
                  <ul>
                     <li><Link to="" > Monday 11am-7pm</Link></li>
                     <li><Link to="" > Tuesday-Friday 11am-8pm</Link></li>
                     <li><Link to="" > Saturday 10am-6pm</Link></li>
                     <li><Link to="" > Sunday 11am-6pm</Link></li>
                     <li><Link to="" > Festival Day OFF</Link></li>
                  </ul>
            ...
            <div className="d-flex justify-content-center">
               <p>Copyright © 2019. <strong>Divyaa Yoga Institute</strong> All rights reserved</p>
            </div>
         </div >
      </footer >
   )
