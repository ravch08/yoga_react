...
import about from '../assets/abt_img.png';
         ...
         <div className="container">
            ...
            <div className={props.className} data-aos="fade-up">
               <div className="col-sm-12 col-md-5 col-lg-6 text-center">
                  <figure><img src={about} className="info-img" alt="About Us" /></figure>
               </div>
               <div className="col-sm-12 col-md-7 col-lg-6 text-right pt-5">
                  ...
                  <a href="contact.html" className="w-btn btn-2 bdr1-30 mt-4">Get in Touch</a>
               </div>
            </div>
